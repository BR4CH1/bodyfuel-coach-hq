-- BodyFuel Mahlzeitenbilder
--
-- Ein Bild wird an der Mahlzeit gespeichert und beim Tracken als Snapshot in
-- food_entries übernommen. Dadurch bleibt der Tagebucheintrag unabhängig von
-- späteren Änderungen am Rezept.
...
-- Mahlzeitenfotos enthalten keine privaten Profildaten und werden als
-- öffentliche, cachebare Assets ausgeliefert. Schreibzugriffe laufen nur über
-- authentifizierte Server-Funktionen mit Service Role.
