...
function CoachShell() {
  ...
  const isDetail = pathname !== "/coach";
  return (
    <AppLayout>
      {isDetail ? <Outlet /> : <CoachList />}
    </AppLayout>
  );
}
          ...
          return (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-xs text-gold">{level.name} · {pts} Pkt</div>
          ...
          <tbody>
            {CLIENTS.map((c) => {
              ...
              return (
                <tr
                  key={c.id}
                  className="border-b border-border last:border-0 transition hover:bg-secondary/40"
                >
