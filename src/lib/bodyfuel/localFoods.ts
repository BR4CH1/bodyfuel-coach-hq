...
type LocalFoodSeed = Omit<LocalFood, "unit" | "density_g_per_ml"> & {
  unit?: LocalFood["unit"];
...
export const LOCAL_FOODS: LocalFood[] = LOCAL_FOOD_SEEDS.map((food) => ({
  ...food,
  unit: food.unit ?? "g",
  density_g_per_ml: food.density_g_per_ml ?? null,
}));
