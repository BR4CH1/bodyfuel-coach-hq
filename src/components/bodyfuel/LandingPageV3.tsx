...
const systemFeatures = [
  {
    icon: Apple,
    title: "Ernährung",
    text: "Einfach tracken, besser essen und bewusste Entscheidungen treffen.",
  },
  {
    icon: Dumbbell,
    title: "Training",
    text: "Smarte Trainingspläne, Übungen, Fortschritt und Workouts im Blick.",
  },
  {
    icon: BarChart3,
    title: "Tracking",
    text: "Kalorien, Makros, Schritte und mehr — übersichtlich an einem Ort.",
  },
  {
    icon: LineChart,
    title: "Fortschritt",
    text: "Sieh, was du erreichst. Daten schaffen Motivation und Klarheit.",
  },
  {
    icon: Heart,
    title: "Motivation",
    text: "Gewohnheiten aufbauen, dranbleiben und deine Ziele erreichen.",
  },
];
...
function BrandLogo({ compact = false }: { compact?: boolean }) {
  return (
    <img
      ...
      className={compact ? "h-11 w-11 object-contain" : "h-11 w-auto max-w-[190px] object-contain sm:h-12"}
    />
  );
}
    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#050806]/90 backdrop-blur-xl">
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <Link
            to="/app"
            className="inline-flex h-9 items-center justify-center rounded-lg border border-gold/35 bg-transparent px-3 text-xs font-semibold text-white transition hover:bg-gold/10 sm:px-4 sm:text-sm"
          >
            Login
          </Link>
          <Link to="/trial">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 pb-20 pt-14 sm:px-6 sm:pt-20 lg:min-h-[720px] lg:grid-cols-[0.8fr_1.2fr] lg:px-8 lg:pb-24 lg:pt-20">
        <div className="relative z-20 max-w-xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="#funktionen">
              <Button size="lg" variant="outline" className="w-full border-gold/45 bg-transparent px-7 text-white hover:bg-gold/10 hover:text-white sm:w-auto">
  ...
  return (
    <div className="mt-8 flex items-center gap-3">
      <div className="flex -space-x-2">
        {["B", "F", "S", "C"].map((letter, index) => (
          <span
            key={`${letter}-${index}`}
            className="grid h-8 w-8 place-items-center rounded-full border-2 border-[#070b09] bg-[#16201a] text-[10px] font-bold text-white"
          >
            {letter}
          </span>
        ))}
      ...
      <div>
        <div className="flex gap-0.5 text-sm text-[#f4b83f]" aria-hidden="true">
          <span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
        </div>
        <div className="mt-0.5 text-xs text-white/60">
          <span className="font-semibold text-white">4,8/5</span> aus 50+ Bewertungen
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative mx-auto min-h-[500px] w-full max-w-[760px] lg:min-h-[590px]">
      ...
      <PhoneShot
        ...
        className="left-[3%] top-[12%] z-10 -rotate-[4deg] sm:left-[7%]"
      />
      <PhoneShot
        src={nutritionPlanAsset.url}
        alt="BodyFuel Ernährungsplan"
        className="left-1/2 top-[4%] z-20 -translate-x-1/2 rotate-[1deg]"
      />
      <PhoneShot
        src={nutritionTrackerAsset.url}
        alt="BodyFuel Ernährungstracking"
        className="right-[2%] top-[13%] z-10 rotate-[4deg] sm:right-[5%]"
      />

      <img
        src={fuelyHappyAsset.url}
        alt="Fuely, der BodyFuel Begleiter"
        className="absolute bottom-[-2%] right-[0%] z-30 h-[150px] w-auto drop-shadow-[0_20px_35px_rgba(0,0,0,0.55)] sm:h-[190px] lg:h-[220px]"
      />
    </div>
  );
}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          <div>
            <h2 className="font-display text-4xl font-bold leading-tight text-white sm:text-5xl">
              Dein System. <span className="text-gradient-gold">Deine Ergebnisse.</span>
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-white/55 sm:text-base">
              BodyFuel verbindet die Dinge, die deinen Fortschritt bestimmen — klar, messbar und ohne Tool-Chaos.
            </p>
          </div>
          ...
          <div className="relative hidden min-w-[300px] rounded-2xl border border-gold/30 bg-gold/5 p-5 lg:block">
            ...
            <div className="ml-28">
              <div className="font-semibold text-white">Hi, ich bin Fuely! 👋</div>
              <p className="mt-2 text-xs leading-5 text-white/55">
                Dein Daily Coach in der App. Ich erinnere dich, motiviere dich und feiere deine Erfolge mit dir.
              </p>
              <Link to="/trial" className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-gold">
                Fuely kennenlernen <ArrowRight className="h-3 w-3" />
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-5">
          {systemFeatures.map((feature) => (
            <article key={feature.title} className="bg-[#090d0b] p-6 transition hover:bg-[#0e1511]">
              <feature.icon className="h-7 w-7 text-gold" />
              <h3 className="mt-4 text-base font-semibold text-white">{feature.title}</h3>
              <p className="mt-2 text-xs leading-5 text-white/55">{feature.text}</p>
            </article>
          ))}
        </div>
      </div>
    ...
    <section id="app" className="border-y border-white/10 bg-[#090d0b] py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            <div className="text-xs font-bold uppercase tracking-[0.22em] text-gold">Echte Einblicke</div>
            <h2 className="mt-3 font-display text-4xl font-bold text-white sm:text-5xl">BodyFuel in Action</h2>
          </div>
          <p className="max-w-lg text-sm leading-6 text-white/50">
            Keine generierten Produktbilder — echte Screenshots aus der BodyFuel App.
          </p>
        </div>

        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {shots.map((shot) => (
            <figure key={shot.title} className="group overflow-hidden rounded-2xl border border-white/10 bg-[#0d1210] transition hover:-translate-y-1 hover:border-gold/35">
              <div className="border-b border-white/10 px-4 py-4">
                <div className="text-[9px] font-bold uppercase tracking-[0.18em] text-gold">{shot.eyebrow}</div>
                <div className="mt-1 font-display text-xl font-bold text-white">{shot.title}</div>
              </div>
              <div className="max-h-[470px] overflow-hidden">
                <img src={shot.src} alt={shot.title} loading="lazy" className="w-full transition duration-500 group-hover:scale-[1.02]" />
              </div>
            </figure>
          ))}
        </div>
    ...
    <section id="coaching" className="py-24 sm:py-28">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20 lg:px-8">
        <div className="relative mx-auto w-full max-w-md lg:mx-0">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#0d1210]">
            <img src={manuCoachAsset.url} alt="Manu, Head Coach von BodyFuel" loading="lazy" className="aspect-[4/5] w-full object-cover" />
            <div className="absolute inset-x-4 bottom-4 rounded-2xl border border-white/10 bg-black/65 p-4 backdrop-blur-lg">
              <div className="font-display text-xl font-bold text-white">MANU</div>
              <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-gold">Head Coach · BodyFuel</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <h2 className="mt-4 font-display text-4xl font-bold leading-[1.02] text-white sm:text-5xl lg:text-6xl">
            App im Rücken.<br /><span className="text-gradient-gold">Coach an deiner Seite.</span>
          </h2>
          <p className="mt-6 max-w-2xl text-base leading-7 text-white/55">
            Du willst nicht nur ein System, sondern persönliche Führung? Im Coaching werden Ernährung und Training individuell begleitet und laufend an deinen Fortschritt angepasst.
          </p>

          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            {[
              { icon: MessageCircle, text: "Direkter persönlicher Support" },
              { icon: ClipboardList, text: "Wöchentliche Check-ins" },
              { icon: Dumbbell, text: "Individuelle Plananpassungen" },
              { icon: ShieldCheck, text: "Klare Führung & Feedback" },
            ].map((item) => (
              <div key={item.text} className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/[0.025] p-4 text-sm text-white/80">
          ...
          <a href="#kontakt" className="mt-8 inline-flex">
            <Button className="bg-gradient-gold text-primary-foreground shadow-gold hover:opacity-90">
              Coaching anfragen <ArrowRight className="ml-1 h-4 w-4" />
            </Button>
          </a>
        </div>
      </div>
    ...
    <section id="preise" className="border-y border-white/10 bg-[#090d0b] py-24 sm:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="text-xs font-bold uppercase tracking-[0.22em] text-gold">Wähle deinen Weg</div>
          <h2 className="mt-4 font-display text-4xl font-bold text-white sm:text-5xl">Smart oder <span className="text-gradient-gold">Coaching.</span></h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-white/50 sm:text-base">
            Dasselbe BodyFuel Fundament — selbstständig mit Smart oder mit persönlicher Begleitung im Coaching.
          </p>
        </div>

        <div className="mx-auto mt-12 grid max-w-4xl gap-5 md:grid-cols-2">
          {PACKAGES.map((pkg) => (
            <article key={pkg.key} className={`relative flex flex-col rounded-2xl border p-7 sm:p-8 ${pkg.popular ? "border-gold/50 bg-gradient-to-b from-gold/10 to-[#0d1210] shadow-gold" : "border-white/10 bg-[#0d1210]"}`}>
              {pkg.popular && (
                <span className="absolute right-5 top-5 rounded-full bg-gradient-gold px-3 py-1 text-[9px] font-bold uppercase tracking-[0.16em] text-primary-foreground">Persönlich</span>
              )}
              ...
              <ul className="space-y-3">
                {pkg.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-3 text-sm leading-6 text-white/75">
              ...
              {pkg.key === "smart" ? (
                ...
                <Button size="lg" onClick={() => handleBuy(pkg.priceId)} className="w-full bg-gradient-gold text-primary-foreground shadow-gold hover:opacity-90">
    ...
    <section id="faq" className="py-24 sm:py-28">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h2 className="mt-4 font-display text-4xl font-bold text-white sm:text-5xl">Noch Fragen?</h2>
        </div>

        <div className="mt-10 space-y-3">
          {faqs.map((faq) => (
            <details key={faq.q} className="group rounded-2xl border border-white/10 bg-[#0d1210] p-5 open:border-gold/30">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-4 font-semibold text-white">
                {faq.q}
                <ChevronDown className="h-4 w-4 shrink-0 text-gold transition group-open:rotate-180" />
              </summary>
              <p className="mt-4 max-w-3xl text-sm leading-7 text-white/55">{faq.a}</p>
            </details>
          ))}
        </div>
      </div>
    ...
    <section id="kontakt" className="border-t border-white/10 bg-[#090d0b] py-24 sm:py-28">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-[0.82fr_1.18fr] lg:gap-20 lg:px-8">
        <div className="relative">
          <div className="text-xs font-bold uppercase tracking-[0.22em] text-gold">Persönlich sprechen</div>
          <h2 className="mt-4 font-display text-4xl font-bold leading-[1.02] text-white sm:text-5xl">
            Bereit für deinen<br /><span className="text-gradient-gold">nächsten Schritt?</span>
          </h2>
          <p className="mt-5 max-w-lg text-sm leading-7 text-white/55 sm:text-base">
            Du bist noch unsicher, welches BodyFuel Paket zu dir passt? Schick kurz deine Eckdaten — die Anfrage ist unverbindlich.
          </p>
          ...
          <img src={fuelyHappyAsset.url} alt="Fuely" className="mt-8 h-44 w-auto lg:absolute lg:bottom-[-35px] lg:right-0 lg:mt-0" />
        </div>

        {done ? (
          <div className="grid min-h-[430px] place-items-center rounded-2xl border border-gold/30 bg-gold/5 p-8 text-center">
            <div>
          ...
          <form onSubmit={submit} className="rounded-2xl border border-white/10 bg-[#0d1210] p-6 sm:p-8">
...
function Field({ label, htmlFor, children }: { label: string; htmlFor: string; children: ReactNode }) {
  return (
    <div className="space-y-2">
      <Label htmlFor={htmlFor} className="text-white/75">{label}</Label>
      {children}
    </div>
  );
}
    ...
    <footer className="border-t border-white/10 bg-[#050806] py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <BrandLogo />
            <p className="mt-4 max-w-sm text-sm leading-6 text-white/45">Ernährung, Training und Fortschritt in einem klaren System.</p>
          </div>
...
function FooterCol({ title, children }: { title: string; children: ReactNode }) {
  return (
    <div>
      <div className="font-display text-sm font-bold uppercase tracking-[0.12em] text-white">{title}</div>
      <div className="mt-4 flex flex-col gap-2.5 text-sm text-white/45 [&_a:hover]:text-white [&_button:hover]:text-white">{children}</div>
    </div>
  );
}
